...
#ifndef __vtkBirchDoubleSlider_h
#define __vtkBirchDoubleSlider_h
...
/// \ingroup Widgets
/// vtkBirchDoubleSlider is a QSlider that controls doubles instead of integers.
/// vtkBirchDoubleSlider internally aggregates a QSlider
/// TODO: vtkBirchDoubleSlider tries to represent a double value with integers. It's
/// of course non-optimal and can lead to errors, it would be better if
/// vtkBirchDoubleSlider works like QDoubleSpinBox, where the value is a QVariant
/// and the conversion between double and integer is only done to convert
/// to/from screen coordinates.
/// \sa ctkRangeSlider, vtkBirchDoubleRangeSlider, ctkRangeWidget
class vtkBirchDoubleSlider : public QWidget
{
  Q_OBJECT
...
protected:
  QScopedPointer<vtkBirchDoubleSliderPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(vtkBirchDoubleSlider);
  Q_DISABLE_COPY(vtkBirchDoubleSlider);
};
