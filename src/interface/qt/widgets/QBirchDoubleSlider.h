 ...
 *
 * QBirchDoubleSlider internally aggregates a QSlider.
 * TODO: QBirchDoubleSlider tries to represent a double value with integers. It's
 * of course non-optimal and can lead to errors, it would be better if
 * QBirchDoubleSlider works like QDoubleSpinBox, where the value is a QVariant
 ...
 *
 * @see QBirchFramePlayerWidget
 */
#ifndef __QBirchDoubleSlider_h
#define __QBirchDoubleSlider_h
...
class QBirchDoubleSlider : public QWidget
{
  Q_OBJECT
  ...
  public:
     ...
     */
    explicit QBirchDoubleSlider(QWidget* parent = 0);

    /**
     * Constructors, builds a slider whose default values are the same as
     * QSlider (vertical by default).
     */
    explicit QBirchDoubleSlider(Qt::Orientation orient, QWidget* parent = 0);

    /** Destructor */
    virtual ~QBirchDoubleSlider();
  ...
  protected:
    QScopedPointer<QBirchDoubleSliderPrivate> d_ptr;

  private:
    Q_DECLARE_PRIVATE(QBirchDoubleSlider);
    Q_DISABLE_COPY(QBirchDoubleSlider);
};
