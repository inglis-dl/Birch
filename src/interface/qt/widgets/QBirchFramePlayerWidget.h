/*==============================================================================
  ...
  Program:   Birch
  Module:    QBirchFramePlayerWidget.cxx
  Language:  C++
 ...
 *
 * @see QBirchDoubleSlider, QBirchSliderWidget, vtkMedicalImageViewer, QBirchSliceView
 */
#ifndef __QBirchFramePlayerWidget_h
#define __QBirchFramePlayerWidget_h
...
class QBirchFramePlayerWidgetPrivate;

class QBirchFramePlayerWidget : public QWidget
{
  Q_OBJECT
  ...
  public:
    ...
    explicit QBirchFramePlayerWidget(QWidget* parent = 0);
    virtual ~QBirchFramePlayerWidget();
    ...
    void setSliceView(QBirchSliceView* sliceView);
  ...
  protected:
    QScopedPointer<QBirchFramePlayerWidgetPrivate> d_ptr;
    QPointer<QBirchSliceView> sliceViewPointer;

  private:
    Q_DECLARE_PRIVATE(QBirchFramePlayerWidget);
    Q_DISABLE_COPY(QBirchFramePlayerWidget);
};
