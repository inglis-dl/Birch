...
#ifndef __QBirchDoubleSpinBox_h
#define __QBirchDoubleSpinBox_h
...
/// The QBirchDoubleSpinBox internaly uses a QDoubleSpinBox while it retain controls
/// over it.
/// \sa ctkDoubleSlider, ctkSliderWidget
class QBirchDoubleSpinBox : public QWidget
{
  Q_OBJECT
  Q_ENUMS(SetMode)
...
public:
  ...
  /// Constructor, creates a QBirchDoubleSpinBox. The look and feel
  /// are the same as of a QDoubleSpinBox
  explicit QBirchDoubleSpinBox(QWidget* parent = 0);
  explicit QBirchDoubleSpinBox(QBirchDoubleSpinBox::SetMode mode, QWidget* parent = 0);
  virtual ~QBirchDoubleSpinBox();
  ...
  /// value property.
  /// \sa displayedValue(), setValue(), value()
  ...
  /// \sa QBirchDoubleSpinBox::DecimalsOption
  int decimals() const;
  ...
  QBirchDoubleSpinBox::SetMode setMode() const;
  void setSetMode(SetMode mode);

  /// Set/Get the option used to input the decimals.
  /// \sa QBirchDoubleSpinBox::DecimalsOption
  QBirchDoubleSpinBox::DecimalsOptions decimalsOption();
  void setDecimalsOption(QBirchDoubleSpinBox::DecimalsOptions option);
...
protected:
  QScopedPointer<QBirchDoubleSpinBoxPrivate> d_ptr;
...
Q_DECLARE_METATYPE(QBirchDoubleSpinBox::SetMode)
Q_DECLARE_OPERATORS_FOR_FLAGS(QBirchDoubleSpinBox::DecimalsOptions)

#endif //__QBirchDoubleSpinBox_h
